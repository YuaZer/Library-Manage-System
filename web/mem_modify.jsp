                                    ...
                                    <form action="member?type=modify" method="post">
                                        <table width="100%" class="cont">
                                            ...
                                            <tr>
                                                <td width="2%">&nbsp;</td>
                                                <td width="10%">用户名：</td>
                                                <td width="20%"><input class="text" type="text" name="name"
                                            ...
                                            <tr>
                                                <td width="2%">&nbsp;</td>
                                                <td>密码：</td>
                                                <td><input class="text" type="password" name="pwd" value="${member.pwd}"
                                                           required/></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>电话号码</td>
                                                <td>
                                                    <input class="text" type="tel" name="tel" value="${member.tel}"
                                                           required/>
                                                </td>
                                                <td></td>
                                                <td width="2%">&nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>身份证号</td>
                                                <td>
                                                    <input class="text" type="text" name="idNumber"
