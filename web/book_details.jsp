                                    ...
                                    <form action="" method="">
                                        <table width="100%" class="cont">
                                            <tr>
                                                <td width="2%">&nbsp;</td>
                                                <td>编号：</td>
                                                <td width="20%"><input class="text" type="text" name="bookId"
                                                                       value="${book.id}" disabled="disabled"/></td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%"><input class="text" type="text" name="name"
                                                                       value="${book.name}" disabled="disabled"/></td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%">
                                                    <input class="text" type="text" name="type"
                                                           value="${book.type.name}" disabled="disabled"/>
                                                </td>
                                                <td width="2%">&nbsp;</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%"><input class="text" type="text" name="publish"
                                                                       value="${book.publish}" disabled="disabled"/>
                                                </td>
                                                <td></td>
                                                <td width="2%">&nbsp;</td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2"><textarea cols="150" rows="20"
                                                                          disabled="disabled">${book.desc}</textarea>
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
