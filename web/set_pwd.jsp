                                    ...
                                    <form action="user?type=modifyPwd" method="post">
                                        <table width="100%" class="cont">
                                            <tr>
                                                ...
                                                <td width="150px"><input class="text" type="password" name="pwd"
                                                                         value=""/></td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="150px"><input class="text" type="password" name="newpwd"
                                                                         value=""/></td>
                                                <td></td>
                                                <td width="2%">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="150px"><input class="text" type="password" name="newpwd2"
                                                                         value=""/></td>
