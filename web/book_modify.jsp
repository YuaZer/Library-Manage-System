                                    ...
                                    <form action="book?type=modify" method="post" enctype="multipart/form-data">
                                        <table width="100%" class="cont">
                                            <tr>
                                                <td width="2%">&nbsp;</td>
                                                <td>编号：</td>
                                                <td width="20%"><input class="text" type="text" name="id"
                                                                       value="${book.id}" readonly/></td>
                                                <td rowspan="8" valign="top">
                                                    <fieldset style="width: 210px; height: 370px;">
                                                        <legend>图片预览</legend>
                                                        <img id="imgPic" src="${book.pic}" width="200px"
                                                             height="350px"/>
                                                    </fieldset>
                                                </td>
                                                <td width="2%">&nbsp;</td>
                                            ...
                                            <tr>
                                                <td width="2%">&nbsp;</td>
                                                <td width="15%">名称：</td>
                                                <td width="25%"><input class="text" type="text" name="name"
                                                                       value="${book.name}"/></td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%"><input class="text" style="width:50px;" type="number"
                                                                       name="stock" value="${book.stock}"/></td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%"><input class="text" style="width:100px;" type="text"
                                                                       name="price" value="${book.price}"/></td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2"><textarea cols="150" rows="20"
                                                                          name="desc">${book.desc}</textarea></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
